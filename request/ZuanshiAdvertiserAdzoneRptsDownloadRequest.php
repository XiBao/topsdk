<?php
/**
 * TOP API: taobao.zuanshi.advertiser.adzone.rpts.download request
 * 
 * @author auto create
 * @since 1.0, 2015.03.25
 */
class ZuanshiAdvertiserAdzoneRptsDownloadRequest
{
	/** 
	 * 查询结束时间
	 **/
	...
	{
		return "taobao.zuanshi.advertiser.adzone.rpts.download";
	}
