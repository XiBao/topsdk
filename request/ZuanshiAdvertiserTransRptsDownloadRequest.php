<?php
/**
 * TOP API: taobao.zuanshi.advertiser.trans.rpts.download request
 * 
 * @author auto create
 * @since 1.0, 2015.03.25
 */
class ZuanshiAdvertiserTransRptsDownloadRequest
{
	/** 
	 * 查询结束时间
	 **/
	...
	{
		return "taobao.zuanshi.advertiser.trans.rpts.download";
	}
