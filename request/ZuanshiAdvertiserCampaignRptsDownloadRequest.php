<?php
/**
 * TOP API: taobao.zuanshi.advertiser.campaign.rpts.download request
 * 
 * @author auto create
 * @since 1.0, 2015.03.25
 */
class ZuanshiAdvertiserCampaignRptsDownloadRequest
{
	/** 
	 * 查询结束时间
	 **/
	...
	{
		return "taobao.zuanshi.advertiser.campaign.rpts.download";
	}
