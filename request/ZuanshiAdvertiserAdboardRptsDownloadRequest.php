<?php
/**
 * TOP API: taobao.zuanshi.advertiser.adboard.rpts.download request
 * 
 * @author auto create
 * @since 1.0, 2015.03.25
 */
class ZuanshiAdvertiserAdboardRptsDownloadRequest
{
	/** 
	 * 查询结束时间
	 **/
	...
	{
		return "taobao.zuanshi.advertiser.adboard.rpts.download";
	}
